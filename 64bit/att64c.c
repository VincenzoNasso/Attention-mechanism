...
void att(params *input){
	...
	for (int i = 0; i < numeroDiFette; i++){
		...
		if(input->n % 16 == 0 && input->d % 16 == 0 && input->nn % 16 == 0){
			...
			quartaFase_U4(matriceSecondaTerzaFase,matriceV,input->out,input->n,input->nn, inizioFetta);
		}
			...
			quartaFase_U3(matriceSecondaTerzaFase,matriceV,input->out,input->n,input->nn, inizioFetta);
		}
			...
			quartaFase_U2(matriceSecondaTerzaFase,matriceV,input->out,input->n,input->nn, inizioFetta);
		}
		else{
			...
			quartaFase_U1(matriceSecondaTerzaFase,matriceV,input->out,input->n,input->nn, inizioFetta);
		}
		inizioFetta += 8 * input->n * input->nn;
	}
